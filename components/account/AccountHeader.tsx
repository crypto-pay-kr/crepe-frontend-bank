...
const AccountHeader: React.FC<AccountHeaderProps> = ({ bankName, onAddAccount }) => {
  return (
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex text-sm text-gray-500 font-medium">
            ...
            <span className="hover:text-gray-700 cursor-pointer transition-colors duration-200">은행 상세 관리</span>
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-800">연결된 계좌 관리</span>
          </div>
        </div>
        <button
