        ...
        <div className="p-4 bg-white shadow-sm mb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-lg font-medium">은행 이름</h1>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              <div>
                <div className="text-xs text-gray-500 mb-1">가맹 전화</div>
                <div className="flex">
                  <input
                    type="text"
                    value="010-1234-5678"
                  ...
                  />
                  <button className="ml-1 px-3 py-1 bg-blue-500 text-white rounded-md">
                    변경
                  </button>
                </div>
              </div>
              <div>
                <div className="text-xs text-gray-500 mb-1">010-1234-4567</div>
                <div className="flex">
                  <input
                    type="text"
                    value="010-1234-4567"
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              <div>
                <div className="text-xs text-gray-500 mb-1">가맹 번호선택</div>
                <div className="flex">
                  <input
                    type="text"
                    value="010-1234-4567"
            ...
            <div className="space-y-3">
              <Link href="/dashboard/wallet" className="text-xs text-gray-500">
